...
const fallbackBlogs: Blog[] = [
  {
    ...
    excerpt:
      "Discover hidden gems that are just as mesmerizing as popular tourist spots, while keeping your trip affordable and stress-free with Journve's smart travel planner.",
  ...
  },
  {
    ...
    excerpt:
      "Planning a trip should be exciting—not overwhelming. From juggling budgets to organizing itineraries, learn how Journve simplifies every aspect of your journey.",
    content: "This is a fallback blog post content.",
    image: "/placeholder.svg?height=400&width=600",
    date: new Date().toISOString(),
    readTime: "5 min read",
  ...
  },
  {
    ...
    excerpt:
      "Dreaming of travel but worried about expenses? Whether you're a student, solo backpacker, or budget-savvy globetrotter, Journve is your ultimate partner for affordable travel planning.",
    content: "This is a fallback blog post content.",
    image: "/placeholder.svg?height=400&width=600",
    date: new Date().toISOString(),
    readTime: "4 min read",
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div className="h-[400px] lg:h-[600px] relative rounded-2xl overflow-hidden">
                  <Image
                    ...
                    alt={`${featuredPost.title} - Featured Travel Article`}
                    fill
