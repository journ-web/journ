            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {topSupportTopics.map((topic, index) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-black rounded-2xl p-6 border border-gray-100 dark:border-gray-900 hover:shadow-lg transition-all duration-300 cursor-pointer"
