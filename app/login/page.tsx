        ...
        <div className="container px-6 md:px-12">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              className="relative h-[400px] md:h-[600px] rounded-2xl overflow-hidden hidden md:block"
            >
              <AuthImageCarousel />
              <div className="absolute bottom-0 left-0 p-8 text-white z-10">
                <h2 className="text-3xl font-bold mb-2">Welcome Back</h2>
                <p className="text-white/80">Log in to continue your journey with Journve.</p>
              </div>
            </motion.div>
            ...
            >
              <div className="mb-8 text-center md:text-left">
                <h1 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">Login</h1>
